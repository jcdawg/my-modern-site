...
export default function WhoToHireVpSalesStartup() {
    ...
    const interviewLoop = [
        ...
        { stage: "6. Offer", who: "Founder", test: "Close, equity story, start date", time: "—" },
    ];
                ...
                <div className="mx-auto max-w-4xl space-y-20">
                            ...
                            <li className="flex items-start gap-4 bg-grey-50 p-6 rounded-2xl border border-grey-100">
                                ...
                                <div>
                                    ...
                                    <p className="text-grey-600 mt-2 leading-relaxed">
                                        Lock comp band, equity slice, and must-have stage/motion. Write the scorecard; define 90-day success metrics. Decide decision-makers and interview loop. Run a <strong>free market scan in 48–72 hours</strong> with a specialist partner if you use Kas. Do not post a vague JD and hope—calibration is the search.
                                    </p>
                                </div>
                            </li>
                            <li className="flex items-start gap-4 bg-grey-50 p-6 rounded-2xl border border-grey-100">
                                ...
                                <div>
                                    ...
                                    <p className="text-grey-600 mt-2 leading-relaxed">
                                        Map operators who built <em>your</em> motion at <em>your</em> stage—not job-board applicants only. Direct outreach to passive VP / Head of Sales talent. Target signal: <strong>3+ qualified candidates in 3 weeks</strong> (Kas search guarantee: hit that bar or we keep hunting free).
                                    </p>
                                </div>
                            </li>
                            <li className="flex items-start gap-4 bg-grey-50 p-6 rounded-2xl border border-grey-100">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid gap-4">
                            ...
                            <div className="flex gap-4 p-6 rounded-2xl border border-grey-100 bg-grey-50/30">
                                <BadgeCheck className="h-6 w-6 text-blue-accent shrink-0 mt-0.5" />
                                <div>
                                    <h3 className="font-bold text-navy-900 text-lg">AI/ML recruiting with Ph.D.-led technical vetting</h3>
                                    <p className="text-grey-600 mt-1 leading-relaxed">
                                        PhD Statistics, ex-Microsoft Lead Data Scientist (
                                        <Link href="/recruit/ai" className="text-blue-accent hover:underline">AI recruiting</Link>)
                                    </p>
                                </div>
                            </div>
                            <div className="flex gap-4 p-6 rounded-2xl border border-grey-100 bg-grey-50/30">
                                <BadgeCheck className="h-6 w-6 text-blue-accent shrink-0 mt-0.5" />
                                <div>
                                    <h3 className="font-bold text-navy-900 text-lg">Clear guarantees</h3>
                                    <p className="text-grey-600 mt-1 leading-relaxed">48–72h market scan; 3+ qualified candidates in 3 weeks or keep hunting free; 60-day re-hunt</p>
                                </div>
                            </div>
                        </div>
                        <p className="text-grey-600 leading-relaxed">
                    ...
                    <div className="p-12 rounded-[2rem] bg-navy-900 text-white text-center shadow-2xl relative overflow-hidden">
                        ...
                        <p className="text-grey-400 mb-8 max-w-lg mx-auto relative z-10">
                            Send stage, ARR band, ACV, current AE count, and target VP comp. You get a free market scan in 48–72 hours and a clear call: stay AE-led, hire a player-coach, or open a full VP search.
                        </p>
